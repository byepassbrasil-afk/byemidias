...
const PUBLIC_ROUTES = ['/login', '/signup', '/forgot-password', '/reset-password', '/api/auth/login', '/api/auth/signup', '/api/auth/logout', '/api/auth/forgot-password', '/api/auth/reset-password', '/api/test-pb', '/api/test', '/api/test-crud', '/api/test-direct', '/api/health', '/api/thumbnail', '/manifest.json', '/sw.js', '/offline.html'];
